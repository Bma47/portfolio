...
<head>
   ...
   <title><?= $page_title ?> |Games|Fighting</title>
...
<header>
   ...
   <h1 class="text-games">fighting games <h1>
   <section class="section-1">
  <!-- content -->
  <div class="games-container" style="display: flex; padding:10px; flex-wrap: wrap;">
    <?php if(!empty($games)): ?>
      <?php foreach($games as $game): ?>
        <?php if($game['best_sold'] == 7): ?>
          <!-- card -->
          <div class="game-card" style="flex-basis: 40% margin:20px;">
